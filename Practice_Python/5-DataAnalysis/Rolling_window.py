...
rolmean = df_close.rolling(12).mean() #rolling.mean(): tính trung bình cửa sổ trượt
...
for i in range(n_windows):
    ...
    end_index = min((i + 1) * window_size, len(df_close))
    window_data = df_close[start_index:end_index]
